...
if annie%4 == 0:
    ...
    print("Both were not born in a year")
...
# use loop to check how many ratings is greater or equal to 8 for list rating
...
print("\n------ Example 8: functions ------")
# define a function to add 1 to a number. The number is passed to the function as an agrument
def add(n):
    updated = n + 1
...
print(f"The class average is = {grade_average()}")